...
class ResepBaruScreen extends StatelessWidget {
  const ResepBaruScreen({super.key});
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const BannerTittle(
              text: 'Resep Terbaru', // Judul banner
              imageAsset: 'images/home/makanan.png', // Gambar banner
              gradientColor1: AppColors.primary, // Warna gradien
            ),
