...
class _IngredientListState extends State<IngredientList> {
  ...
  void goToLetter(String letter) {
    ...
    final index = ingredients.indexWhere(
      (ingredient) => ingredient.name.toLowerCase().startsWith(letter.toLowerCase()),
    );

    // Scroll to the found index if it exists
    if (index != -1) {
      _scrollController.animateTo(
        index * 80.0, // Assuming each item has a height of 80. Adjust as needed.
  ...
  child: Padding(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        color: selectedLetter == letter ? AppColors.primary : Colors.transparent,
      ...
      child: Text(
        ...
        style: TextStyle(
          ...
          color: selectedLetter == letter ? Colors.white : AppColors.darkTextSecondary,
        ),
      ),
    ),
  ),
