          ...
          child: Material(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    _buildOptionItem(Icons.restaurant, 'Dari resep anda', theme),
                    Divider(height: 1, color: AppColors.primary.withOpacity(0.8)),
                    _buildOptionItem(Icons.bookmark, 'Dari resep tersimpan', theme),
                    Divider(height: 1, color: AppColors.primary.withOpacity(0.8)),
                    _buildOptionItem(Icons.search, 'Cari resep', theme),
                  ],
                ),
              ),
            ),
